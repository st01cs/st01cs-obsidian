...
tags:
  ...
  - claudecode
---
**[claude-code-guide](https://github.com/Cranot/claude-code-guide)** Public

Claude Code Comprehensive Guide

[Open in github.dev](https://github.dev/) [Open in a new github.dev tab](https://github.dev/) [Open in codespace](https://github.com/codespaces/new/Cranot/claude-code-guide?resume=1)

<table><thead><tr><th colspan="2"><span>Name</span></th><th colspan="1"><span>Name</span></th><th><p><span>Last commit message</span></p></th><th colspan="1"><p><span>Last commit date</span></p></th></tr></thead><tbody><tr><td colspan="3"><p><span><a href="https://github.com/Cranot/claude-code-guide/commit/27852d7c19da94cccd42e4d505c4227d637a74ac">27852d7</a> ·</span></p><p><a href="https://github.com/Cranot/claude-code-guide/commits/main/"><span><span><span>10 Commits</span></span></span></a></p></td></tr><tr><td colspan="2"><p><a href="https://github.com/Cranot/claude-code-guide/blob/main/README.md">README.md</a></p></td><td colspan="1"><p><a href="https://github.com/Cranot/claude-code-guide/blob/main/README.md">README.md</a></p></td><td><p><a href="https://github.com/Cranot/claude-code-guide/commit/27852d7c19da94cccd42e4d505c4227d637a74ac">Update README.md</a></p></td><td></td></tr><tr><td colspan="3"></td></tr></tbody></table>

## Quick Navigation

- 🚀 [Instant Command Reference](https://github.com/Cranot/#instant-command-reference) - Commands you need right now
- 🎯 [Feature Quick Reference](https://github.com/Cranot/#feature-quick-reference) - Key features at a glance
- 🔥 [Power User Shortcuts](https://github.com/Cranot/#power-user-shortcuts) - Advanced combinations
- 📋 [Task State Reference](https://github.com/Cranot/#task-state-reference) - Understanding states
- 🔧 [Common Workflows Card](https://github.com/Cranot/#common-workflows-card) - Proven patterns
- 📋 [Key Findings from Deep Claude Tools Exploration](https://github.com/Cranot/#key-findings-from-deep-claude-tools-exploration) - Tool discoveries
- 🧠 [Advanced REPL Synergy Patterns](https://github.com/Cranot/#advanced-repl-synergy-patterns) - Computational intelligence
- 🧠 [Specialized Kernel Architecture Integration](https://github.com/Cranot/#specialized-kernel-architecture-integration) - Cognitive systems
- 🎯 [Meta-Todo System: Intelligent Task Orchestration](https://github.com/Cranot/#meta-todo-system-intelligent-task-orchestration) - Smart task management
- 🔥 [Advanced Synergy Implementations](https://github.com/Cranot/#advanced-synergy-implementations) - Advanced combinations
- 🏁 [Core Concepts (Start Here)](https://github.com/Cranot/#core-concepts-start-here) - Foundation knowledge
- ⚡ [Slash Commands](https://github.com/Cranot/#slash-commands) - Command system
- 🔗 [Hooks System](https://github.com/Cranot/#hooks-system) - Event automation
- 🤖 [MCP Integration & Sub-Agents](https://github.com/Cranot/#mcp-integration--sub-agents) - External integrations
- 🔄 [Development Workflows](https://github.com/Cranot/#development-workflows) - Proven approaches
- 🛡️ [Error Recovery](https://github.com/Cranot/#error-recovery) - Problem solving
- 💡 [Practical Examples](https://github.com/Cranot/#practical-examples) - Real-world scenarios
- 🚀 [Advanced Patterns](https://github.com/Cranot/#advanced-patterns) - Expert techniques
...
1. **[🚀 Quick Reference Cards](https://github.com/Cranot/#quick-reference-cards)** - Instant lookup for common tasks and features
2. **[Core Concepts](https://github.com/Cranot/#core-concepts-start-here)** - Basic tools, permissions, project context, memory management
3. **[Cognitive Systems](https://github.com/Cranot/#specialized-kernel-architecture-integration)** - Kernel architecture, intelligence coordination
4. **[Slash Commands](https://github.com/Cranot/#slash-commands)** - System/custom commands, templates, organization
5. **[Hooks System](https://github.com/Cranot/#hooks-system)** - Events, patterns, security, automation
6. **[MCP Integration](https://github.com/Cranot/#mcp-integration--sub-agents)** - External systems, OAuth, configuration, subagents
7. **[Development Workflows](https://github.com/Cranot/#development-workflows)** - Core approaches, task management patterns
8. **[Quality Assurance](https://github.com/Cranot/#quality-assurance-patterns)** - Automation, validation, multi-agent review
9. **[Error Recovery](https://github.com/Cranot/#error-recovery)** - Common patterns, progressive strategies
10. **[Practical Examples](https://github.com/Cranot/#practical-examples)** - Real-world scenarios for various tasks
11. **[Advanced Patterns](https://github.com/Cranot/#advanced-patterns)** - Research systems, Smart Flows, cognitive approaches
12. **[Best Practices](https://github.com/Cranot/#best-practices)** - Principles for development, quality, efficiency
13. **[Troubleshooting](https://github.com/Cranot/#troubleshooting)** - Common issues, solutions, diagnostics
14. **[Security Considerations](https://github.com/Cranot/#security-considerations)** - Security model, best practices, audit trails
15. **[Tool Synergy Mastery](https://github.com/Cranot/#advanced-synergy-implementations)** - Advanced combinations and integrations
...
- Tools can be combined for powerful workflows (e.g., web\_search → web\_fetch → repl → artifacts)
...
[↑ Back to Top](https://github.com/Cranot/#quick-navigation)
...
> **🧑💻 Start Here**: New to Claude Code? Begin with [Core Capabilities](https://github.com/Cranot/#core-claude-code-capabilities), then explore [Permission Model](https://github.com/Cranot/#permission-model), and set up your first [CLAUDE.md](https://github.com/Cranot/#project-context-claudemd).
...
❌ **Wrong**: Acting on first impression ✅ **Right**: Analyze entire message, capture all requirements

❌ **Wrong**: Trust that merge/edit worked ✅ **Right**: Always verify completeness and correctness

❌ **Wrong**: Minimal context to agents ✅ **Right**: Generous context including patterns and conventions

❌ **Wrong**: One task at a time when independent ✅ **Right**: Batch independent tasks (up to 10)

❌ **Wrong**: Retry same approach after failure ✅ **Right**: Learn from error and adjust strategy
...
@analyzer "Extract insights from $PATTERNS" @architect "Suggest improvements"

/security-review --continuous &

for dir in $(claude --list-dirs); do (cd $dir && update-patterns.sh) done

if \[ $(context-size) -gt 6000 \]; then /microcompact fi

@predictor "Analyze trends in background logs"

sleep 3600 # Run hourly done
