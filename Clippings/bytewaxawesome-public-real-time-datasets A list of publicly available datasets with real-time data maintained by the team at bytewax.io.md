...
tags:
  - "clippings"
---
做数据分析或开发实时应用，对于实时数据源尤为重要，但想要找到稳定的 API 接口，极其困难。  
  
无独有偶，在 GitHub 上发现了 Awesome Public Real-Time Datasets 这份精心整理的实时数据源列表。 

主要内容：  
  
- 金融/加密货币数据：Coinbase、Binance 等交易所的实时行情和订单簿数据；  
- 交通运输数据：全球航班、地铁、公交等实时位置和状态信息；  
- 天气环境数据：NOAA、OpenWeather 等提供的实时天气和空气质量数据；  
- 网络安全数据：SSL 证书日志、恶意 URL、威胁情报等实时安全信息；  
- 物联网数据：ThingSpeak 等平台的公开传感器数据流；  
- 其他特色数据：GitHub 事件流、国际空间站实时数据、F1 赛车遥测等。  
  
同时列表明确区分免费和付费数据源，还附带详细的 API 文档链接，帮助我们快速找到合适的数据源。
**[awesome-public-real-time-datasets](https://github.com/bytewax/awesome-public-real-time-datasets)** Public

A list of publicly available datasets with real-time data maintained by the team at bytewax.io

[bytewax.io](https://bytewax.io/ "https://bytewax.io")

[CC0-1.0 license](https://github.com/bytewax/awesome-public-real-time-datasets/blob/main/LICENSE)

[Code of conduct](https://github.com/bytewax/awesome-public-real-time-datasets/blob/main/CODE_OF_CONDUCT.md)

[Contributing](https://github.com/bytewax/awesome-public-real-time-datasets/blob/main/contributing.md)

[1.5k stars](https://github.com/bytewax/awesome-public-real-time-datasets/stargazers) [118 forks](https://github.com/bytewax/awesome-public-real-time-datasets/forks) [18 watching](https://github.com/bytewax/awesome-public-real-time-datasets/watchers) [Branches](https://github.com/bytewax/awesome-public-real-time-datasets/branches) [Tags](https://github.com/bytewax/awesome-public-real-time-datasets/tags) [Activity](https://github.com/bytewax/awesome-public-real-time-datasets/activity) [Custom properties](https://github.com/bytewax/awesome-public-real-time-datasets/custom-properties)

Public repository

[Open in github.dev](https://github.dev/) [Open in a new github.dev tab](https://github.dev/) [Open in codespace](https://github.com/codespaces/new/bytewax/awesome-public-real-time-datasets?resume=1)
...
- \- US government-led service that enables public and private organizations to exchange machine-readable threat indicators in real time.
