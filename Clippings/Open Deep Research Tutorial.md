...
tags:
  - "clippings"
---
This tutorial demonstrates how to train your own deep research agent using GRPO to exceed Sonnet 4’s perfromance. Specifically, you will be using the [ART](https://github.com/OpenPipe/ART) library to specialize Qwen2.5 14B for [Langchain’s open deep research](https://github.com/langchain-ai/open_deep_research) framework, and will evaluate your agent’s performance using [DeepResearch Bench: A Comprehensive Benchmark for Deep Research Agents](https://github.com/Ayanami0730/deep_research_bench).In addition to the GRPO training step, you will also run an initial SFT training run to improve the model’s baseline performance.
