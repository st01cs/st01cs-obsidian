...
tags:
  - "clippings"
---
Tone.js 是一个用于在浏览器中创建交互式音乐的 Web Audio 框架。Tone.js 的架构设计旨在让音乐人和音频程序员都能轻松上手，用于创建基于网络的音频应用。在高层功能上，Tone 提供了类似数字音频工作站(DAW)的常见特性，例如用于同步和调度事件的全局传输控制器，以及预制合成器和效果器。此外，Tone 还提供了高性能的基础模块，用于创建自定义合成器、效果器和复杂的控制信号。
