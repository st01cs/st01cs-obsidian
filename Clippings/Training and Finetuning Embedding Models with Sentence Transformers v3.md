...
[Update on GitHub](https://github.com/huggingface/blog/blob/main/train-sentence-transformers.md)
...
This article is also available in Chinese [简体中文](https://huggingface.co/blog/zh/train-sentence-transformers).
...
- [Why Finetune?](https://huggingface.co/blog/#why-finetune)
- [Training Components](https://huggingface.co/blog/#training-components)
- [Dataset](https://huggingface.co/blog/#dataset)
	- [Data on Hugging Face Hub](https://huggingface.co/blog/#data-on-hugging-face-hub)
	- [Local Data (CSV, JSON, Parquet, Arrow, SQL)](https://huggingface.co/blog/#local-data-csv-json-parquet-arrow-sql)
	- [Local Data that requires pre-processing](https://huggingface.co/blog/#local-data-that-requires-pre-processing)
	- [Dataset Format](https://huggingface.co/blog/#dataset-format)
- [Loss Function](https://huggingface.co/blog/#loss-function)
- [Training Arguments](https://huggingface.co/blog/#training-arguments)
- [Evaluator](https://huggingface.co/blog/#evaluator)
	- [EmbeddingSimilarityEvaluator with STSb](https://huggingface.co/blog/#embeddingsimilarityevaluator-with-stsb)
	- [TripletEvaluator with AllNLI](https://huggingface.co/blog/#tripletevaluator-with-allnli)
- [Trainer](https://huggingface.co/blog/#trainer)
	- [Callbacks](https://huggingface.co/blog/#callbacks)
- [Multi-Dataset Training](https://huggingface.co/blog/#multi-dataset-training)
- [Deprecation](https://huggingface.co/blog/#deprecation)
- [Additional Resources](https://huggingface.co/blog/#additional-resources)
	- [Training Examples](https://huggingface.co/blog/#training-examples)
	- [Documentation](https://huggingface.co/blog/#documentation)
...
1. [**Dataset**](https://huggingface.co/blog/#dataset): The data used for training and evaluation.
2. [**Loss Function**](https://huggingface.co/blog/#loss-function): A function that quantifies the model's performance and guides the optimization process.
3. [**Training Arguments**](https://huggingface.co/blog/#training-arguments) (optional): Parameters that influence training performance and tracking/debugging.
4. [**Evaluator**](https://huggingface.co/blog/#evaluator) (optional): A tool for evaluating the model before, during, or after training.
5. [**Trainer**](https://huggingface.co/blog/#trainer): Brings together the model, dataset, loss function, and other components for training.
...
It's crucial to ensure that your dataset format matches your chosen [loss function](https://huggingface.co/blog/#loss-function). This involves checking two things:
...
[![](https://huggingface.co/blog/assets/embeddinggemma/thumbnail.png)](https://huggingface.co/blog/embeddinggemma)

## [Welcome EmbeddingGemma, Google's new efficient embedding model](https://huggingface.co/blog/embeddinggemma)

[

By [tomaarsen](https://huggingface.co/tomaarsen) September 4, 2025 • 230

](https://huggingface.co/blog/embeddinggemma)

[![](https://huggingface.co/blog/assets/train-sentence-transformers/st-hf-thumbnail.png)](https://huggingface.co/blog/train-sparse-encoder)
...
By [tomaarsen](https://huggingface.co/tomaarsen) July 1, 2025 • 123

](https://huggingface.co/blog/train-sparse-encoder)

### Community

[Chidanand](https://huggingface.co/Chidanand)

[@ tomaarsen](https://huggingface.co/tomaarsen),kindly let us know how to to carryout finetuning qlora-peft combinations? It helps a lot

[nebulousest](https://huggingface.co/nebulousest)

•

[edited May 31](https://huggingface.co/blog/#6839f2e96f186ef9e13bd380 "Edited by nebulousest")
