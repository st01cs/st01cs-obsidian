---
title: "Vertical Integration is the Only Thing That Matters"
source: "https://becca.ooo/blog/vertical-integration/"
author:
published: 2025-11-10
created: 2025-12-04
description: "The utility of a tool is limited by the amount of the system it understands"
tags:
  - "clippings"
---
...
2. IDEs make some of these workflows possible, albeit scoped to a single project. This is because IDEs implement glue integrations between a bunch of different test runners, build systems, languages, and so on.
...
Industrial users aren’t interested in a smooth developer experience because it makes engineers’ lives easier. Industrial users want a vertically-integrated stack because engineer time is *expensive.* This means that a vertically-integrated stack must save time in an absolute sense; that is,*including* the time it takes to implement and adopt the system.
